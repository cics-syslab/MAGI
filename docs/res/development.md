**Note**: This is the documentation for developing a addon. If you are looking for the instructions for using the existing module and the framework. Refer to the main readme.
