...
class PageBaseSettings:
    def __init__(self, tab_control):
        ...
        ModuleTab(tab_control, self.page, ["None"] + list(ModuleManager.available_modules.keys()), "Enabled Module",
                  (self.base_settings.__dict__, "enabled_module"))
        PluginTab(tab_control, self.page, ModuleManager.available_plugins.keys(), "Enabled Plugins",
